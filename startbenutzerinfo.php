...
<form id="benutzerinfo" method="post" action="phpfiles/do_write_benutzerprofil.php">
    <div class="input-group">
        <label>Fakultät</label>
        <input type="text" name="fakultät" required>
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
        <button type="submit" class="btn" name="write_info">Weiter zum Login</button>
    </div>
</form>
